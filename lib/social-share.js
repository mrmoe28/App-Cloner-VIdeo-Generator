...
class SocialShareService {
  ...
  async shareVideo({ platform, videoId, caption, userId = 'default', accessToken }) {
    try {
      ...
      switch (platform) {
        case 'youtube':
          shareResult = await this.shareToYouTube(video, caption, accessToken);
          break;
        case 'tiktok':
          shareResult = await this.shareToTikTok(video, caption, accessToken);
          break;
        case 'instagram':
          shareResult = await this.shareToInstagram(video, caption, accessToken);
          break;
        case 'twitter':
          shareResult = await this.shareToTwitter(video, caption, accessToken);
          break;
        case 'facebook':
          shareResult = await this.shareToFacebook(video, caption, accessToken);
          break;
        case 'linkedin':
          shareResult = await this.shareToLinkedIn(video, caption, accessToken);
          break;
        default:
